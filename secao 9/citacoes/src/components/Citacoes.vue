...
/* 1 passo
   importar citacao para citacoes

   Citacoes: importar o componente citacao
   Citacoes: registrar localmente o componente citacao
   Citacao: registrar no props a variaveis do conteudo